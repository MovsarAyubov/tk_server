...
func StartRouter(port string) {
	...
	router.GET("/api/v1/fetch_done_works_by_worker_id", v1.FetchDonWorksByWorkerId)
	router.GET("/api/v1/get_done_work_by_cellId_and_date", v1.GetDoneWorkByDateAndCellID)
